...
<s:if test="groupList.size()==0"><div style="position:fixed;top:40%;textalign:centger;"><a data-toggle="modal" data-target="#groupAdd" class="cursor">グループに参加していません。<br>グループを作成してみましょう。</a></div>
</s:if>
</div>
    </div>
